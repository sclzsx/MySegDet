...
def split_binary(data_root, save_dir):
    ...
    ok_dir_test = save_dir + '/Test_OK'
    ng_dir_test = save_dir + '/Test_NG'
...
if __name__ == '__main__':
    # split_binary('./carpet', './carpet_binary73')

    split_multi('./carpet', './carpet_multi64')

    # augment('./carpet_multi')
